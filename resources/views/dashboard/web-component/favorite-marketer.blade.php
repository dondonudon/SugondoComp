...
@section('page title','WEB Component Favorite Marketer')
...
@section('script')
    <script>
        ...
        function fetchData(functionTarget) {
            kvAjax('{{ url('admin/web-component/favorite-marketer/list') }}','',functionTarget);
        }

        function deleteData(response) {
            if (response === 'success') {
                fetchData(setDisplayData);
                kvAjax('{{ url('admin/web-component/favorite-marketer/list-marketer') }}','',setSelectMarketer);
        ...
        document.addEventListener('DOMContentLoaded', function (event) {
            ...
            btnDelete.addEventListener('click', function (e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        kvAjax('{{ url('admin/web-component/favorite-marketer/delete') }}','id='+vID,deleteData);
                    }
                });
            });
            ...
            formData.addEventListener('submit', function (e) {
                ...
                kvAjax(
                    '{{ url('admin/web-component/favorite-marketer/add') }}',
                    encodeURI(data),
                    cSubmit
                );
