                    ...
                    <div class="card card-primary card-outline">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="iFullname" name="fullname" value="{{ $data->fullname }}" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="iJabatan">Jabatan</label>
                                    <input type="text" class="form-control" id="iJabatan" name="jabatan" value="{{ $data->jabatan }}" readonly>
                                </div>
        ...
        FilePond.setOptions({
            ...
            server: {
                process: (fieldName, file, metadata, load, error, progress, abort) => {
                    ...
                    request.open('POST','{{ url('admin/web-component/our-team/submit-edit-gambar') }}');
