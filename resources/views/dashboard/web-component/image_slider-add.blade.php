...
@section('page title','WEB Component Image Slider - Tambah Gambar')
            ...
            <div class="row">
                <div class="col-lg">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body">
                            <p>Suggested Size: 940 x 528 px</p>
                            <div class="row">
                                <div class="col-lg">
                        ...
                        <div class="card-footer">
                            <div class="row justify-content-end">
                                <div class="col-lg-2 mt-2 mt-sm-0">
                                    <a href="{{ url('admin/web-component/image-slider') }}" class="btn btn-outline-danger btn-block">Cancel</a>
                                </div>
                                <div class="col-lg-2 mt-2 mt-sm-0">
...
@section('script')
    ...
    <script>
        ...
        FilePond.setOptions({
            ...
            imageResizeTargetHeight: 940,
            imageResizeTargetWidth: 528,
            ...
            server: {
                process: (fieldName, file, metadata, load, error, progress, abort) => {
                    ...
                    request.open('POST','{{ url('admin/web-component/image-slider/upload/submit') }}');
                        ...
                        if (request.status >= 200 && request.status < 300) {
                            ...
                            if (request.responseText === 'success') {60785
                                Swal.fire({
                                    ...
                                    title: 'Tersimpan',
                                    onClose: function () {
                                        window.location.href = '{{ url('admin/web-component/image-slider') }}';
                                    }
                                });
                            }
                        } else {
